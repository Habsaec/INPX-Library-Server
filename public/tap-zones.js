/** Pure helpers for AlReaderX-style 9-zone taps (short/long). Labels come from web i18n (`reader.tapAction.*`). */

export const TAP_ZONE_IDS = Object.freeze(['tl', 'tm', 'tr', 'ml', 'mm', 'mr', 'bl', 'bm', 'br']);

/** Actions available in the web reader settings UI (no autoFlip). */
